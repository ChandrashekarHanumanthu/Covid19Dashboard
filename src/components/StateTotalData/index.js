...
class StateTotalData extends Component {
  ...
  getEachState = async () => {
    ...
    const confirmedData = {
      name: 'Confirmed',
      logo: 'https://res.cloudinary.com/amst/image/upload/v1639929248/conf_cof3e9.jpg',
      value: totalConfirmed,
    }

    const activeData = {
      name: 'Active',
      logo: 'https://res.cloudinary.com/amst/image/upload/v1639929248/act_kq7nfx.jpg',
      value: totalActive,
    }

    const recoveredData = {
      name: 'Recovered',
      logo: 'https://res.cloudinary.com/amst/image/upload/v1639929248/uyf_ndpqov.jpg',
      value: totalRecovered,
    }
    const deceasedData = {
      name: 'Deceased',
      logo: 'https://res.cloudinary.com/amst/image/upload/v1639929248/dese_tgak4e.jpg',
      value: totalDeceased,
    }
